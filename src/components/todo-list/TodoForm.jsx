...
function TodoForm({ todo, onTitleChange, onDescriptioChange,todoDescription,  onSubmit, isEditing, modalShow, setModal }) {
  ...
  return (
    <>
     <Button variant="primary" onClick={handleShow}>
        ...
        <form className="row m-0 g-3 align-items-end justify-content-center" onSubmit={onSubmit}>
