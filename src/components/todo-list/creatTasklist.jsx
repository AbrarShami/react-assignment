...
const Tasklist = ({editable, editTodo, deleteTodo, updateTodo, updateText, updateTodotext, todolist, todoStatus}) => {
    const { taskId } = useParams();
    const editble = editable;
    ...
    if (editable) {
        return (
            ...
            <tr key={td.key} className={td.taskStatus ? 'active' :'not-active'}>
                ...
                <td className='text-center width-50'>
                    <Link type="button" to={`/tasks/${td.key}`} class="btn btn-outline-danger">
